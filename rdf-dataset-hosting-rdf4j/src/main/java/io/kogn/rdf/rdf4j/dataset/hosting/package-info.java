 ...
 * {@code SparqlUpdateRdf4j}, {@code DatasetExportRdf4j}, {@code DatasetTransactorRdf4j}),
 * composed over the {@code Repository} this module constructs. Hosting is thus the only
 * part of the RDF4J backend that assembles a concrete store; the content adapters merely
 * wrap a caller-supplied one (see ADR-0009).</p>
 */
